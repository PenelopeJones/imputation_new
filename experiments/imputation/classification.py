...
def main(args):
    ...
    with open('results/{}/{}/{}/{}.txt'.format(args.dataname, args.task_type, args.model_name, filename), 'a') as f:
        ...
        if args.model_name == 'baseline':
            ...
            r2_scores, rmses, roc_aucs = model.metrics_calculator(x, save=False)
            write_classification_metrics(r2_scores, rmses, roc_aucs, file=f, set_type='train')

            r2_scores, rmses, roc_aucs = model.metrics_calculator(x_test, save=True)
            write_classification_metrics(r2_scores, rmses, roc_aucs, file=f, set_type='test')
